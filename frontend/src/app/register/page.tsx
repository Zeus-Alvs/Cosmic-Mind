  ...
  return (
    <div className="flex h-screen w-full bg-white">
      ...
      <div className="hidden md:flex flex-col justify-center items-start p-16 w-1/2 bg-[#0F172A] text-white relative overflow-hidden">
        ...
        <h1 className="text-4xl font-bold mb-8 relative z-10">Já tem uma<br />conta?</h1>
        <Link href="/login" className="flex items-center px-6 py-3 border-2 border-white rounded-full hover:bg-white hover:text-cyan-500 transition font-medium relative z-10">
      ...
      <div className="flex flex-col items-center w-full md:w-1/2 p-6 md:p-8 overflow-y-auto">
        <div className="w-full max-w-md my-auto">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-bold text-transparent bg-clip-text bg-[#4078A4]   mb-2">Cadastrar</h2>
          ...
          <form onSubmit={fazerCadastro} className="bg-slate-100 p-6 rounded-2xl shadow-inner space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <label className={`flex items-center justify-center p-3 border rounded-xl cursor-pointer transition ${tipoPerfil === 'responsavel' ? 'bg-cyan-50 border-cyan-400 ring-2 ring-cyan-300' : 'bg-white border-slate-200 hover:bg-slate-50'}`}>
                  <input
                    type="radio"
                    name="role"
                    value="responsavel"
            ...
            <div className="flex flex-col space-y-1">
              ...
              <input
                ...
                required
                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-cyan-400 text-slate-800"
              />
            </div>
            ...
            <div className="flex flex-col space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-4 py-2.5 pr-12 rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-cyan-400 text-slate-800"
                />
                <button
                  type="button"
