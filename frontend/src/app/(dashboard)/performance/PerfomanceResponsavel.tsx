...
export default function PerfomanceR() {
  ...
  // 👇 Substituí o ID do Netuno pelo ID REAL do seu Unity/MongoDB 👇
  const planetasBase: Planeta[] = [
    { id: '57b6d77617cbdc1499b06cab3d9f650e', nome: 'Netuno', desafio: 'Resgate Crítico', cor: 'bg-[#4A59BD]' },
    { id: 'urano', nome: 'Urano', desafio: 'Órbita Complexa', cor: 'bg-[#38BDF8]' }, // Troque pelo ID real depois
    { id: 'saturno', nome: 'Saturno', desafio: 'Anéis de Poeira', cor: 'bg-[#C5A059]' }, // Troque pelo ID real depois
  ...
  useEffect(() => {
    ...
    const buscarPlaneta = async () => {
      ...
      try {
        ...
        // 👇 AQUI A GENTE PASSA O ID DO PLANETA PRO PYTHON FILTRAR! 👇
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-5 bg-transparent font-sans text-slate-600 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-8 items-center md:items-start justify-center">
          ...
          <div className="bg-white border border-slate-100 p-5 rounded-[2.5rem] shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-4">
              {planetasBase.map((p, index) => {
                ...
                // LÓGICA DE BLOQUEIO: Lê o banco de dados. 
                // Se o ID do planeta NÃO estiver no array do jogador, ele bloqueia!
                // (Para testar o layout sem travar tudo, deixamos Netuno liberado por padrão)
        ...
        {/* COLUNA DIREITA: ESTATÍSTICAS REAIS DO BACKEND (FILTRADAS POR PLANETA) */}
