...
export default function NotificacoesS() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      // Simulação de dados voltados para o Especialista
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans">
      <div className="fixed top-0 left-64 right-0 h-1 bg-gradient-to-r from-[#AC57EB] via-[#4078A4] to-[#3E89AE] z-50" />
